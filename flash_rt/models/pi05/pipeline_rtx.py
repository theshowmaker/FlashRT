...
class Pi05Pipeline:
    ...
    def set_language_embeds_torch(self, lang_embeds_t, actual_prompt_len: int | None = None) -> None:
        ...
        if (hasattr(self, "_lang_embeds_buf")
            ...
            # Keep a Python reference until the async copy completes on the
            # current stream. This mirrors torch's lifetime expectations for
            # D2D copies initiated via ctypes.
